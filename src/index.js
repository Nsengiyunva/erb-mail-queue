...
// ── Uploads file server ───────────────────────────────────────────
// Serves engineer documents (technical reports, career reports, etc.)
// uploaded to /home/user1/uploads/ on disk.
//
// PDFs are served inline so the browser opens them in a new tab.
// All other file types are sent as attachments (download prompt).
//
// URL pattern: GET /api/erb/uploads/:filename
//   e.g. https://helper.erb.go.ug/api/erb/uploads/1781899310593-report.pdf
//
// The frontend fileUrl() helper extracts the bare filename from the
// DB-stored relative path and builds this URL.
