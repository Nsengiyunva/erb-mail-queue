...
// ── Status normaliser ─────────────────────────────────────────────
// The VM1 watcher sends statuses like "failed" / "success" / "completed".
// The table stores upper-case states. Map them to one canonical set so a
// success from any source always lands as SUCCESS, a failure as FAILED.
